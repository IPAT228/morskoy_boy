...
function getFallbackQuestions(){return[
  ...
  {id:2,text:'Какое условие проверяет попадание?',code_snippet:'def check_hit(board, r, c):\n    return board[r][c] == 1',
  ...
  {id:7,text:'Что хранит двумерный массив в Морском бое?',code_snippet:'for r in range(SIZE):\n    for c in range(SIZE):\n        state = grid[r][c]',
